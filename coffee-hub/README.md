...
get the app created:
    ...
    $ heroku apps:create coffeehub
    Creating coffeehub... done, stack is cedar
    http://coffeehub.herokuapp.com/ | git@heroku.com:coffeehub.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://coffeehub.herokuapp.com deployed to Heroku

    To git@heroku.com:coffeehub.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://coffeehub.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@coffeehub.herokuapp.com/repl
